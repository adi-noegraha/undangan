...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-FW5PN4B7XE"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-FW5PN4B7XE');
    </script>
    ...
    <meta property="og:url" content="https://dewanakl.github.io/undangan/">
...
<body data-email="user@example.com" data-password="12345678" data-url="https://undangan-api.x.devcloud.my.id">
